...
ifeq (true,$(RAGEL))
    ...
    server: main.o queue.o request.o postgres.o parser.o response.o ragel-http-parser/http_parser.o
		$(CC) $(CFLAGS) $+ -luv -lpq -o $@
    ...
    ifeq (true,$(DEBUG))
        server: main.o queue.o request.o postgres.o parser.o response.o nodejs-http-parser/http_parser_g.o
			$(CC) $(CFLAGS) $+ -luv -lpq -o $@
        nodejs-http-parser/http_parser_g.o: Makefile
			$(MAKE) -C nodejs-http-parser http_parser_g.o
    else
        server: main.o queue.o request.o postgres.o parser.o response.o nodejs-http-parser/http_parser.o
			$(CC) $(CFLAGS) $+ -luv -lpq -o $@
