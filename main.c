...
int main(int argc, char **argv) {
    ...
    if ((error = uv_loop_close(&loop))) { ERROR("uv_loop_close\n"); return error; } // int uv_loop_close(uv_loop_t* loop)
    return error;
}
